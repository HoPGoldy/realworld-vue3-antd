...
<div>
    ...
    <a-card class="comment-meta" style="width: 100%; background-color: #f8f8f8;">
        <a-row justify="space-between" >
            ...
            <a-col>
                <a-button v-if="showDeleteButton" :loading="deleting" type="text" danger size="small" @click="onDeleteComment">
                    <template #icon>
                        <DeleteFilled />
                    </template>
                </a-button>
...
const emits = defineEmits<{ (event: 'delete', id: CommentId): void }>();
